...
const featureList = computed(() => {
  ...
  return [
    ...
    'Отклик уходит прямо в backend работодателю',
  ]
})
      ...
      <template v-else-if="job">
        ...
        <section class="content-grid">
          <div class="main-column">
            ...
            <section class="panel company-panel">
              ...
              <div class="company-note">
                ...
                <p>Публикация доступна на платформе и принимает отклики напрямую через backend без промежуточных заглушек.</p>
              </div>
            </section>
          </div>
          ...
          <form class="panel apply-form" @submit.prevent="submitApplication">
            ...
            <p class="form-note">
              Данные отправятся работодателю напрямую через backend. Часть полей уже
