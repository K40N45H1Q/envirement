...
.site-footer {
  ...
  background:
    radial-gradient(circle at top left, rgba(37, 167, 108, 0.16), transparent 30%),
    radial-gradient(circle at bottom right, rgba(20, 184, 87, 0.1), transparent 28%),
    var(--surface-primary);
}
...
.brand-link,
.footer-meta span {
  text-shadow: 0 0.0625rem 0 rgba(0, 0, 0, 0.02);
}
